...
(function () {
    ...
    daBai.Config.map = [
        ...
        { path: '/shooting/locationDetailAdd', view: 'shooting/locationDetailAdd.html', viewUrl: 'shooting/locationDetailAdd.html', styles: null, scripts: 'shooting/locationDetailAdd', modules: 'shootingLocationDetailAdd' }
